...
static const _ActiveSquirtleStats_type_support_symbol_names_t _ActiveSquirtleStats_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, squirtlebot_interfaces, msg, ActiveSquirtleStats)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, squirtlebot_interfaces, msg, ActiveSquirtleStats)),
  }
};
...
{
  return &::squirtlebot_interfaces::msg::rosidl_typesupport_cpp::ActiveSquirtleStats_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, squirtlebot_interfaces, msg, ActiveSquirtleStats)() {
  return get_message_type_support_handle<squirtlebot_interfaces::msg::ActiveSquirtleStats>();
}
