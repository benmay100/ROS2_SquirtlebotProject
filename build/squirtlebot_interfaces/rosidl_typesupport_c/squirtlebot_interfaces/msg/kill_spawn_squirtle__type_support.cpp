...
#include "squirtlebot_interfaces/msg/detail/kill_spawn_squirtle__type_support.h"
...
static const _KillSpawnSquirtle_type_support_symbol_names_t _KillSpawnSquirtle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, squirtlebot_interfaces, msg, KillSpawnSquirtle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, squirtlebot_interfaces, msg, KillSpawnSquirtle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, squirtlebot_interfaces, msg, KillSpawnSquirtle)() {
  return &::squirtlebot_interfaces::msg::rosidl_typesupport_c::KillSpawnSquirtle_message_type_support_handle;
}
